...
namespace Tester.TestSales
{
   public class SalesQuotation
   {
      ...
      public async Task Start()
      {
         ...
         {
            frm.Logs("Info", $" Sales Quotation step {Step}", $"FAILED -- {ex.Message}");

         }
         finally
         {
            frm.UpdateStatus("Proses  Sales Quotation Selesai");
         }
      }
      public async Task AllBlank()
      {
         var Proses = " Sales Quotation - Insert - All Blank (Negative)"; frm.UpdateStatus(Proses);
      ...
      {
         var Proses = " Sales Quotation - Insert -  Detail Blank (Negative)"; frm.UpdateStatus(Proses);
         Stopwatch jam = new Stopwatch(); jam.Start(); frm.Test++;
         int Step = 0;
         try
         {
      ...
      {
         var Proses = " Sales Quotation - Insert (Positive)"; frm.UpdateStatus(Proses);
         Stopwatch jam = new Stopwatch(); jam.Start(); frm.Test++;
         int Step = 0;
         try
         {
      ...
      {
         var Proses = " Sales Quotation - Read (Positive)"; frm.UpdateStatus(Proses);
         Stopwatch jam = new Stopwatch(); jam.Start(); frm.Test++;
         int Step = 0;
         try
         {
      ...
      {
         var Proses = " Sales Quotation - Update (Positive)"; frm.UpdateStatus(Proses);
         Stopwatch jam = new Stopwatch(); jam.Start(); frm.Test++;
         int Step = 0;
         try
         {
            Step = 1; // Input Name 
            await App.InputData("//input[@name='Squraian']", "Update");
      ...
      //{
      //   var Proses = " Sales Quotation - Delete (Positive)"; frm.UpdateStatus(Proses);
      //   Stopwatch jam = new Stopwatch(); jam.Start(); frm.Test++;
      //   int Step = 0;
      //   try
      //   {
